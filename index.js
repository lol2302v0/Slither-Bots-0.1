...
Bot.prototype = {
	...
	var spawnBuf = [115,10,randomSkin,15,32,83,112,111,111,107,121,0,66,111,116,115]
...
io.on('connection', function(socket) {
  ...
  var address = socket.request.connection.remoteAddress;
	...
	socket.on('start', function(data) {
		...
		console.log('khongcoten Bots has succesfully started!');
	});
...
asciiArt.font('khongcoten Bots', 'Doom', function(rendered){
